...
//	}
	...
	public static String JSONResult(int code,String description,String info,PageBean page){
		JSONObject jo=new JSONObject();
		jo.element("result", code).element("msg", description)
				.element("currentPage", page.getCurrentPage())
				.element("totalRows", page.getTotalRows())
				.element("totalPages", page.getTotalPages())
				.element("pageSize", page.getPageRecorders())
				.element("info", info);
		return jo.toString();
	}
